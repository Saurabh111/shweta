  ...
  return (
    <section id="contact" className="contact section" ref={ref}>
      <div className="container">
        <div className={`contact__inner fade-in ${inView ? "visible" : ""}`}>
          ...
          <div className="contact__detail-col">
            ...
            <div className="contact__detail">
              ...
              <span className="contact__detail-value">
                Financial Modeling · Equity Research · Analytics Consulting
              </span>
            </div>
          </div>
        </div>
        ...
        <div
          className={`contact__footer fade-in fade-in-delay-2 ${inView ? "visible" : ""}`}
        >
          <p className="contact__footer-name">Shweta Sharma</p>
          <p className="contact__footer-copy">
            © 2025 · Finance & Analytics Professional
          </p>
        </div>
      </div>
    </section>
