        ...
        return (
          <ResponsiveContainer width="100%" height={320}>
            ...
            >
              ...
              <Line
                type="monotone"
                dataKey="fixedAssetsTurnover"
                name="Fixed Assets Turnover (x)"
                stroke={SLATE}
                strokeWidth={2.5}
                dot={{ r: 4, fill: SLATE }}
              />
              <Line
                type="monotone"
                dataKey="debtorsTurnover"
                name="Debtors Turnover (x)"
                stroke={MUTED}
                strokeWidth={2}
                strokeDasharray="5 4"
                dot={{ r: 3, fill: MUTED }}
      ...
      <div className="container">
        ...
        <div className={`project__header fade-in ${inView ? "visible" : ""}`}>
          ...
          <h2 className="project__heading display-heading">
            ...
            <br />
            <em>Equity Analysis</em>
          </h2>
          <p className="project__sub">
            A comprehensive 5-year financial analysis of Tata Power Company
            Ltd., examining capital structure evolution, profitability trends,
            and operational efficiency across FY2021–FY2025.
          </p>
        </div>

        {/* Methodology Row */}
        <div
          className={`project__methodology fade-in fade-in-delay-1 ${inView ? "visible" : ""}`}
        >
          {[
            "Data Collection & Structuring",
            "Financial Statement Modeling",
            "Ratio Calculation (15+ Metrics)",
        ...
        {/* Key Insights */}
        <div
          className={`project__insights fade-in fade-in-delay-2 ${inView ? "visible" : ""}`}
        >
        ...
        {/* Interactive Charts */}
        <div
          className={`project__charts fade-in fade-in-delay-3 ${inView ? "visible" : ""}`}
        >
          ...
          <div className="project__chart-area">{renderChart()}</div>

          <p className="project__chart-note">
            Source: Tata Power Company Ltd. Annual Reports FY2021–FY2025.
            Analysis and modeling by Shweta Sharma.
          </p>
        </div>
      </div>
    </section>
